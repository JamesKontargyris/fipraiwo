...
@section('content')
	<div class="intro">
		<p>This form confirms instructions between Member Units of the Fipra Network. Please fill one out each time you subcontract a Unit, or each time clients directly instruct new work of a subcontracting Unit that ultimately the lead Unit will have to pay for!</p>
	</div>
	<div>
	...
	{{ Form::open(['files' => true]) }}
		...
		<section class="col-6">
			...
			<div class="formfield">
				{{ Form::label('lead_unit', 'Lead Unit:', ['class' => 'required']) }}
			...
			<div class="formfield">
				...
				{{ Form::text('lead_unit_account_director', Input::old('lead_unit_account_director')) }}
				{{ display_form_error('lead_unit_account_director', $errors) }}
			</div>
			<div class="formfield">
				{{ Form::label('sub_contracted_unit_correspondent_affiliate', 'Sub-contracted Unit / Correspondent / Affiliate:', ['class' => 'required']) }}
			...
			<div class="formfield">
				{{ Form::label('sub_contracted_unit_correspondent_affiliate_account_director', 'Sub-contracted Unit / Correspondent / Affiliate Account Director:', ['class' => 'required']) }}
				{{ Form::text('sub_contracted_unit_correspondent_affiliate_account_director', Input::old('sub_contracted_unit_correspondent_affiliate_account_director')) }}
