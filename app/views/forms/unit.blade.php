        ...
        <section class="col-12" style="clear:both">
            ...
            <div class="grey-box">
                <div class="col-10 last">
                    <h4>Invoices</h4>
                    <p>Please note that the Lead Member will not accept an invoice for more than the amount agreed in the Internal Work Order, without prior approval by both sides.</p>
                    ...
                    <p>All payments approved in the IWO system and by the Account Director concerned and therefore due to subcontracting Members of the FIPRA Network are paid out by the Lead Member no later than within 10 working days of relevant payments having been received by the Lead Member from the final client. A Member providing work is under no obligation to automatically inform each subcontracting Member every time a bill is paid. However in the event that a Member makes enquiries about payment of a bill, the Lead Member’s Account Director has an obligation to inform the other Member of when clients made payments or, if known, when they are expected to do so.</p>

                    <h4>Non-payment or reduced-payments by clients</h4>
                    <p>Where there is an IWO,  the Lead Member is responsible for paying each Member of the FIPRA Network in respect of services provided to a client that have been agreed and approved. Once the relevant Account Director has accepted the timesheets of a subcontracting Member, and relevant amounts billed by the Lead Member, the Lead Member will bear the risk of reduced payment, default or non-payment by the end client concerned. It will thus ensure that the subcontracting Member is paid in full, if necessary at the Lead Member's own expense. This is in order to protect subcontracting Members from large-scale defaults and from the wrongdoing of another Member that may cause a client not to pay. It also introduces a degree of financial discipline into the work passed between Members. That a client has refused to pay at all cannot be an excuse for internal non-payment.</p>

                    <p>However, in the rare event that a client does not pay invoices, or pays less than the amount invoiced, the Lead Member may of course seek to negotiate a reduction with the fellow Member collegially, though the subcontracting Member will not be required to enter into such negotiation.</p>

                    <h4>Internal Work Orders</h4>

                    <p>Once agreed, copies of all completed online Internal Work Orders are sent promptly to FIPRA’s finance department to enable the monitoring of Inter-Member activities and to facilitate the Membership Review. Internal Work Orders are treated as confidential and are not disclosed to any person outside the FIPRA finance department and the FIPRA Representative for the Member concerned. The Internal Work Orders serve to calculate the general turnover or the services performed between the Members of the FIPRA Network. No Inter-Member payment of any sort or for any work can take place without an Internal Work Order.</p>
                </div>
            </div>
