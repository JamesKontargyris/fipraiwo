...
class UnitLeadContactTableSeeder extends DatabaseSeeder {
	public function run() {
		...
		$unit_rate_bands = [
			...
			'Fipra Cyprus (New Unit)'       => 'standard',
			...
			'Fipra South Africa (New Unit)' => 'standard',
			...
			'Fipra Uruguay (New Unit)'      => 'standard',
			'Fipra Georgia (New Unit)'      => 'standard',
			'Fipra Austria (New Unit)'      => 'standard',
			'Fipra UK'                      => 'high',
